...
abstract class TagManager extends Manager
{
    /**
     ...
     * @return void
     */
    abstract protected function add($nametag);
     ...
     * @return array
     *//*
    abstract public function getListOf($tag);*/
     ...
     * @return void
     */
    abstract protected function modify(Tag $tag);
